...
<td colspan="4"  align="right"><strong>Datos para el despacho</strong></td></tr>
<tr><td colspan="3" align="left"><strong>Solicitud:  '. $obj->info[0]['nombre'].'</strong></td>
<td colspan="4"  align="right"><strong>'. $estado."-".$ciudad .'</strong></td></tr>
<tr>
<td colspan="3" align="left"><strong>Tel&eacute;fono: '.$obj->info[0]['telefono'].'</strong></td>
<td colspan="4" rowspan="2"  align="right" valign="top"><strong>';
$correo.= $direccion;
$correo.='</strong></td></tr>
<tr><td colspan="3" align="left" valign="top" width="60%"><strong>Correo: '.$obj->info[0]['correo'].'</strong></td></tr>
<tr>
<td colspan="3" align="left"></td>
<td colspan="4"  align="right"><strong>Persona contacto: ' . $persona.'</strong></td></tr>
<td colspan="3" align="left"></td>
<td colspan="4"  align="right"><strong>C&eacute;dula persona contacto: ' . $cedula.'</strong></td></tr>
<tr><td colspan="3" align="left"></td>
<td colspan="4"  align="right"><strong>Telf: '. $telefono.'</strong></td></tr>
...
<td  align="center" style="padding-left:20px;"><strong>Cant.</strong></td>
<td  align="center" width="20%"><strong>Precio Unitario</strong></td>
<td  align="center"  width="20%"><strong>Total</strong></td></tr>';
...
for ($i=0;$i<$n; $i++):
	...
	<td align="center">'.$zapato->info[0]['codigo'].'</td>
	<td align="center">'.$size->info[0]['name'].'</td>

    <td align="center" style="padding-left:20px;">'.$cantidad[$i].'</td>
    <td align="center">BsF. '.number_format($elprecio,2).'</td>
 	<td align="center">BsF. '.number_format($monto,2).'</td></tr>';
	...
	$correo.=' <tr>  <td ></td> <td ></td><td ></td> <td ></td><td ></td>
    <td  align="left"><strong>Sub-total </strong></td>
	<td  align="center"><strong>BsF. '.number_format($total,2).'</strong></td></tr>
   	<tr>    <td ></td> <td ></td><td ></td> <td ></td><td ></td>
    <td  align="left"><strong>Costo Envio </strong></td>
	<td  align="center"><strong>BsF. '. number_format($costoEnvio,2).'</strong></td></tr>
  	<tr>  <td ></td> <td ></td><td ></td> <td ></td> <td ></td>
    <td  align="left"><strong>Total </strong></td>
	<td  align="center"><strong>BsF. ';
  	$total+=$costoEnvio;
	$correo.= number_format($total,2).'</strong></td>  </tr>
    <tr><td></td><td></td><td></td><td></td><td></td><td ></td><td >&nbsp;</td></tr>
     <tr><td colspan="7" align="center"><img src="http://calzadosamano.com/images/24h.jpg" width="500"  />
</td></tr><tr><td colspan="7">&nbsp;</td></tr>

<tr><td colspan="7" align="center"valign="middle" style="background-color:#00a3b4; padding-top:10px;">
 ...
 <a href="https://instagram.com/calzadosamano/" target="_blank"><img src="http://calzadosamano.com/mailing/img/redes_instagram.jpg" /></a>
     ...
     <tr><td colspan="7" align="center"valign="middle" style="background-color:#00a3b4; padding-bottom:10px;"><a href="http://calzadosamano.com/" target="_blank"><img src="http://calzadosamano.com/mailing/img/web.jpg" /></a></td></tr>
