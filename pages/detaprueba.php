...
/*function llenado(n, precio){*/
	...
	var res = str.split("-");
		...
		document.getElementById("descuento").innerHTML ="Bs.F "+res[4];
...
<body>
   ...
   <?php if (strlen($obj->info[0]['descuento'])==0) : ?><div class="descuento">-10%</div><?php endif; ?>
           </div>
              ...
              <a href="javascript: cargar('#cargazapato','cargazapato.php?zapato=<?php echo  $nomImage;?>&nuevo=<?php echo $obj->info[0]['nuevo'];?>&descuento=-10%');"><img src="../images/producto/vistas/thumb/<?php echo  $nomImage;?>" width="60"></a>
              <?php endfor; ?>
              </div>
         </div>
			<div id="derecha">
                ...
                <br><strong><span id="pp"></span><span <?php if (strlen($obj->info[0]['descuento'])==0) : ?>style="text-decoration:line-through; float:left;"<?php endif; ?>></span><span id="descuento" style="margin-left:20px; display:none; <?php if (strlen($obj->info[0]['descuento'])==0) : ?>display:block; float:left;<?php endif; ?>"></span></strong>
                <br><br>
               ...
               <?php if (($obj->info[0]['categoria']=='6')||($obj->info[0]['categoria']=='7')||($obj->info[0]['categoria']=='10')||($obj->info[0]['categoria']=='11')):?>
                ...
                <div id="coloresdisp">Color: <select name="el_color"  id="el_color" onChange="javascript: window.location.href='detaprueba.php?id='+ this.value;" >
                <?php for ($i=0;$i<$m; $i++):
							$back=""; ?>
