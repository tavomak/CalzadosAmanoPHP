...
<body>
	<div id="wrapper">
		...
		<div class="containerPedido" style="padding-top:25px;"  >
	  ...
	  set_time_limit(20);
		...
		?>
                ...
                <tr>
    			<td  colspan="8" height="30" valign="top"><strong>Orden No. <?php echo $pedidos->infoPedidos[$k]['id'];?></strong><br></td>
 				</tr>
  			  	<tr>
    			<td width="7%"></td>
				<td align="center" ><strong>Modelo</strong></td>
				<td align="center" width="19%"><strong>C&oacute;digo</strong></td>
    			<td align="center"><strong>Talla</strong></td>
				<td align="center"><strong>Cantidad</strong></td>
    			<td   width="15%" align="center" ><strong>Precio Unitario</strong></td>
                <td   width="5%"></td>
  			...
  			for ($i=0;$i<$nitems;$i++):
				...
				$elprecio=$precio[0]['precio']*$porcentaje;
  				?>
  				<tr>
    			<td  ><img  src="../images/producto/thumb/<?php echo $obj->info[0]['thumb']; ?>" width="80"></td>
  			...
  			<?php  endfor; ?>
    			<tr><td colspan="7"></td><td  align="center" style="background-color:#999;height:1px;"></td><td colspan="3"></td></tr>
  				...
  				<tr>
   				<td colspan="5"></td><td  align="right"><strong>Subtotal</strong></td><td></td>
				<td   align="center"><strong>BsF. <?php echo number_format($total,2); ?></strong></td>
                <td colspan="3"></td>
  				</tr>
                <tr><td  style="height:1px;" colspan="8"></td>	</tr>
  				<tr>
   				<td colspan="5"></td> <td  align="right"><strong>Costo Env&iacute;o</strong></td><td></td>
				<td   align="center"><strong>BsF. <?php echo number_format($pedidos->infoPedidos[$k]['tot_envio'],2); ?></strong></td>
                <td colspan="3"></td></tr>			  				</tr>
                <tr><td  colspan="7"></td><td  align="center" style="background-color:#999;height:1px;"></td><td colspan="3"></td></tr>
   				<tr>
    			<td  style="height:1px;" colspan="11"></td></tr>
  				<tr>
   				<td colspan="5"></td> <td  align="right" style="height:20px;"><strong>Total</strong></td><td></td>
				<td   align="center"><strong>BsF. <?php $total+= $pedidos->infoPedidos[$k]['tot_envio']; echo number_format($total,2); ?></strong></td>
  				<td colspan="3"></td>
                </tr>
  				<tr>
                ...
                <td align="center"><a href="pagocontarjeta.php?orden= <?php echo $pedidos->infoPedidos[$k]['id'];?>" class="btn_tarjeta"></a></td>
                </tr></table>
                </td>  </tr>
    </tr>
  	...
  	<?php endfor;
		...
		<?php if ($x>0): ?>
			...
			<tr>
    			...
    			<td width="15%" align="center"><strong>Precio Unitario</strong></td>
                <td width="5%"></td>
                <td align="center" width="15%"><strong>Total</strong></td>   <td></td> <td></td><td></td>
  			 </tr>
...
<td  align="center">BsF. <?php echo number_format($elprecio,2); ?>
 ...
 <td  align="center"></td>
    ...
    <td width="5%"></td><td colspan="2" align="center" style="background-color:#999;"></td>
...
<td  align="center"></td>
 ...
 <td  align="center"></td>
    <td  align="center"></td>
<td align="center"></td><td  align="right"><strong>Subtotal</strong></td><td></td>
    <td   align="center"><strong>BsF. <?php echo number_format($total,2); ?></strong></td>
<td  align="center">&nbsp;</td>
    <td ></td>
<td ></td>
