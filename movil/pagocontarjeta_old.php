...
<table width="100%" border="0" id="registro" name="registro" style="color:#009999;" >
  <tr>
    ...
    <td colspan="2" style="color:#999999;padding-left:20px;"><?php echo "Bs.F " .number_format($pedido->info[0]['tot_zapato'],2); ?></td>
  </tr>
  <tr>
    <td align="right">Env&iacute;o</td>
    <td colspan="2" style="color:#999999;padding-left:20px;"><?php echo "Bs.F " .number_format($pedido->info[0]['tot_envio'],2); ?></td>
  </tr>
  <tr>
...
<img src="../images/movil/instapago_logo.jpg" style="width:40%; float:left;"  /><img src="../images/movil/banesco_logo.jpg"  style="width:40%; float:right;" />
