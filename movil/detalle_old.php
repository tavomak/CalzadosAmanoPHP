...
<div class="datos">
 ...
 <div class="fondoCampo"><p class="descripcion" >Tallas: <select name="latalla" onChange="javascript: llenado(this.value);">
 ...
 <div class="fondoCampo" style="margin-top:2px;"><p class="descripcion" >
                   Cantidad: <select name="cantidad" id="cantidad" onChange="javascript: activaAgregar(this.value);">
	</select></p></div>

<div class="fondoCampo" > <p class="descripcion" ><a href="javascript: muestraLista();" style="text-decoration:none; color:#fff;">Otros colores disponibles</a></p> </div>
<div id="listaColores">
                 <?php for ($i=0;$i<$c; $i++): ?>
