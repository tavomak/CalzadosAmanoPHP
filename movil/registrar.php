...
if (count($obj->info)>0) :
	echo "<a href='javascript: document.getElementById('resultado').style.display='none';' >Ya existe este nombre de usuario. &iquest;Quieres volver a intentarlo?</a>";
	exit();
endif;
...
if (strlen($_POST['nombre'])==0) :
	echo "<a href='javascript: document.getElementById('resultado').style.display='none';' >Debes llenar todos los campos</a>";
	exit();
endif;
...
if (checkdate($fecha[1],$fecha[0],$fecha[2])):
	...
	echo "<a href='javascript: document.getElementById('resultado').style.display='none';'>Fecha no valida" . $_POST['birth']."</a>";
	exit();
endif;

if(!filter_var($_POST['correo'], FILTER_VALIDATE_EMAIL))
  {
  echo "<a href='javascript: document.getElementById('resultado').style.display='none';' >Correo no v&aacute;lido</a>";
  exit();
  }

$obj->loadFromCorreo($_POST['correo']);
if (count($obj->info)>0) :
	echo "<a href='javascript: document.getElementById('resultado').style.display='none';'>Ya existe este correo. &iquest;Quieres volver a intentarlo?</a>";
	exit();
endif;
...
if (!is_numeric($_POST['cedula'])):
	echo "<a href='javascript: document.getElementById('resultado').style.display='none';' >C&eacute;dula no v&aacute;lida</a>";
	exit();
endif;

if ($_POST['correo']!=$_POST['confirma']):
echo "<a href='javascript: document.getElementById('resultado').style.display='none';' >Confirme el correo</a>";
	exit();
endif;
...
echo "<a href='javascript: document.getElementById('resultado').style.display='none';' >Confirme la clave</a>";
	exit();
endif;
