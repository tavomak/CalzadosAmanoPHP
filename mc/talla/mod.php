      ...
      <td><table class="fr" width="150" border="0" cellspacing="0" cellpadding="5">
        <tr>
          ...
          <td width="30"><a href="index.php"><img src="../../images/mc/volver.png" /></a></td>
        	...
        	<form action="exec.php" name="frm_mod_banner" id="frm_mod_banner" method="post"  onSubmit="javascript: return isempty();" >
               <?php
					...
					tep_db_connect();
						...
						$listaSel = searchList($criterio,NULL,NULL,NULL,"*",TABLE_TALLA,1);
						tep_db_close();
					endif;
           ...
           <tr>
              <td >Precio Bs.</td>
              <td><input name="precio" type="text" id="precio" size="40" maxlength="255"  value="<?php  echo $listaSel[0]['precio']; ?>" /></td>
            </tr>
            <tr>
              <td >Peso</td>
              <td><input name="peso" type="text" id="peso" size="40" maxlength="255"  value="<?php  echo $listaSel[0]['peso']; ?>" /></td>
            </tr>
            </table>
