...
$title_html="Manejador de contenido";
	...
	$criterio= "";
	$table=TABLE_TALLA;
	$cant = 60; //cantidad maxima de elementos a buscar
		...
		<div id="content">
		  <table border="0" cellspacing="0" cellpadding="0" >
		    <tr>
	          ...
	          <tr>
		         <td colspan="4" id="about_titulo">Tallas</td>
              </tr>
		       <tr>
		         <td width="550" align="right"><a href="mod.php?action=add" style="float:right">Agregar Talla </a></td>
                ...
                <table border="0" align="left" cellspacing="10" >
                  <tbody>
		            ...
		            <tr>
		              <td align="center">&nbsp;</td>
		              <td ><a href="mod.php?id=<?php echo $lista[$i]['id'];?>&amp;action=mod" ><?php echo $lista[$i]['name'];  ?></a></td><td ><a href="mod.php?id=<?php echo $lista[$i]['id'];?>&amp;action=mod" >Bs.<?php echo $lista[$i]['precio'];  ?></a></td>
		             <td align="center"><a href="mod.php?id=<?php echo $lista[$i]['id'];?>&action=mod" ><img src="../../images/mc/editar.png" ></a></td>
		              <td ><span style="padding-left:30px"><a href="exec.php?id=<?php echo $lista[$i]['id'];?>&amp;action=del" onClick="if (! confirm('Seguro que requiere eliminar la talla <?php echo $lista[$i]['name']; ?> ?')) { return false; }" ><img src="../../image/mc/eliminar.jpg" width="26" height="26" alt="Eliminar" /></a></span></td>
	                </tr>
		            <?php endfor; ?>
                    </tbody>
	              </table>
				...
				<?php else : ?>
		        	<p  id="mensaje">No se encontraron tallas cargados</p>
		        <?php endif; ?><br>
		     </td>
	        </tr>
      </table>
