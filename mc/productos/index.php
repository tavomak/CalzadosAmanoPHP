		    ...
		    <tr>
	          ...
	          <tr>
		       ...
		       <tr>
		         ...
		         <td width="550" align="right"><a href="exec.php?action=add" style="float:right">Agregar Producto </a></td>

		         <td><a href="exec.php?action=add" ><img src="../../images/mc/agregar.png" width="26" height="26" /></a></td>
                ...
                <table border="0" align="left" cellspacing="10" >
                  ...
                  <tbody>
		            ...
		            <tr>
                     ...
                     <td align="center" ><a href="exec.php?id=<?php echo $lista[$i]['id'];?>&action=act&categoria=<?php echo $lista[$i]['categoria'];?>" onClick="if (! confirm('Seguro que requiere cambiar el estado del producto?')) { return false; }"><?php if ($lista[$i]['activado']==0) { ?><img src="../../images/mc/red.jpg" alt="Activo"><?php } else {?><img src="../../images/mc/green.jpg" alt="Desactivado"><?php  } ?></a></td>

		              <td ><span style="padding-left:30px"><a href="exec.php?id=<?php echo $lista[$i]['id'];?>&amp;action=del&categoria=<?php echo $lista[$i]['categoria'];?>" onClick="if (! confirm('Seguro que requiere eliminar el producto <?php echo $lista[$i]['name']; ?> ?')) { return false; }" ><img src="../../images/mc/eliminar.png" width="26" height="26" alt="Eliminar" /></a></span></td>

                      <td align="center"><a href="preview.php?id=<?php echo $lista[$i]['id'];?>">Previsualizar</a><a href="../../index_preview.php" target="_blank"><img src="../../images/mc/home.png" ></a></td>
