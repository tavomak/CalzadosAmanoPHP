		...
		<div id="content">
		  <table border="0" cellspacing="0" cellpadding="0" >
		    <tr>
	          ...
	          <tr>
		         <td colspan="4" id="about_titulo">Plantillas</td>
              </tr>
		       <tr>
		         <td width="550" align="right"><a href="exec.php?action=add&cat=<?php echo $_GET['cat']; ?>" style="float:right">Agregar Plantilla </a></td>
