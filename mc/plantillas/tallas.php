      	...
      	<input type="image"  src="../../images/mc/agregar.png" />
               ...
               <table border="0" align="center" cellspacing="1" >
		            ...
		            <tr>
                      ...
                      <td ><span style="padding-left:30px"><a href="exec.php?id=<?php echo $lista[$i]['id'];?>&amp;action=acttalla&amp;id_producto=<?php echo $lista[$i]['id_producto'];?>">
					 ...
					 ?></a></span></td>
		              ...
		              <td ><span style="padding-left:30px"><a href="exec.php?id=<?php echo $lista[$i]['id'];?>&amp;action=del_talla&amp;id_producto=<?php echo $_GET["id"];?>" onClick="if (! confirm('Seguro que requiere eliminar la talla ?')) { return false; }"><img src="../../images/mc/eliminar.png"  alt="Eliminar" /></a></span></td>
