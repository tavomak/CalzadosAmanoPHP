<?php
	...
	case 'add':
		...
		$id=$obj->addProducto();
		header('Location: mod.php?id='.$id . '&action=mod&cat='.$_GET['cat']);
		break;
	...
	case 'mod':
		...
		$obj->mod($_POST['id'],$_POST['categoria'],$_POST['nombre'],$_FILES['big']['name'],$_FILES['thumb']['name'],$_POST['suela'],$_POST['material'],$_POST['posicion'],$_POST['preview'],$_POST['activado'],$_FILES['zoom']['name'],$_FILES['color']['name'],$_POST['precio'],$_POST['nuevo'],$_POST['descuento'],$_POST['plantilla'],$_POST['codigo']);
	...
	case 'del':
		...
		$obj->del($_REQUEST["id"]);
		header('Location: index.php?cat='.$_REQUEST['categoria']);
