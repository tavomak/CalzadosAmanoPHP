                ...
                <table border="0" align="left" cellspacing="10" >
                  ...
                  <tbody>
		            ...
		            <tr>
		              ...
		              <td ><a href="modc.php?id=<?php echo $lista[$i]['id'];?>&amp;action=mod" ><?php echo $lista[$i]['nombre'];  ?></a></td>

		             <td align="center"><a href="modc.php?id=<?php echo $lista[$i]['id'];?>&action=mod" ><img src="../../images/mc/editar.png" ></a></td>
