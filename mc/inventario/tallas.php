...
<div id="wrapper">
	...
	<div id="intwrapper">
	   ...
	   <?php for($i=0;$i<count($listaTalla);$i++) : ?>
                         ...
                         <?php endfor; ?></select>
        <input type="hidden" id="action" name="action" value="addtalla_z" />
		            ...
		            <tr>
                      ...
                      <td align="left" >
                        ...
                        <input type="hidden" id="id" name="id" value="<?php echo $lista[$i]['id']; ?>" />
                         <input type="hidden" id="id_producto" name="id_producto" value="<?php echo $_GET["id"]; ?>" />
                     <input type="hidden" id="dimensiones" name="dimensiones" value="<?php echo $lista[$i]['dimensiones']; ?>" />

                         <input type="hidden" id="id_color" name="id_color" value="<?php echo $lista[$i]['id_color']; ?>" />
