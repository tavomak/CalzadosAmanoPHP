		...
		<div id="content">
		  <table border="0" cellspacing="0" cellpadding="0" >
		    <tr>
	          ...
	          <tr>
		         <td colspan="4" id="about_titulo">Tipos de Suela</td>
              </tr>
		       <tr>
		         <td width="550" align="right"><a href="mod.php?action=add" style="float:right">Agregar Tipo de Suela </a></td>
				...
				<?php else : ?>
		        	<p  id="mensaje">No se encontraron tipos de suela cargadas</p>
		        <?php endif; ?><br>
		     </td>
	        </tr>
      </table>
